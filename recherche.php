<?php
// page d'accueil
$titrePage = 'BioVillefranche - Recherche';

//inclure le header
include 'include/header.php';

//Mr propre (mono tache)
$likeProduit = strip_tags($_POST['recherche']);
//requete
$rqProduits = "SELECT p.idProduit, p.origine, p.prix, p.poids, p.pxkilo, p.dluo, p.reference, p.description, p.stocks, p.photo, p.nom, p.delaisLivraison, f.RS, p.idSCategorie
                FROM produits as p
